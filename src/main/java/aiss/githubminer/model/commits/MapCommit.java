...
import aiss.githubminer.model.commits.Parent;
...
public class MapCommit {
    ...
    public String toString() {
        ...
        sb.append(MapCommit.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("url");
        sb.append('=');
